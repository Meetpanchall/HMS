...
$res = mysqli_query($link,"select* from alogin where Email_id='$Email_id'and Password='$Password'");
                    ...
                    <div class="login-inner-form">
                        <form action="#" method="GET">
                            ...
                            <div class="form-group clearfix mb-0">
                                <button type="submit" value="login" name="login" class="btn btn-primary btn-lg btn-theme">Login</button>
                            </div>
                        </form>
